...
/*Header Javascript Function Start*/
var nav = document.querySelector('nav');
var color = document.getElementsByClassName('nav-link')
...
/*Header Javascript Function End*/
...
// Testimonial slider
	if ($('.owl-carousel.client-slider1').length > 0) {
		$('.owl-carousel.client-slider1').owlCarousel({
			loop: true,
			margin: 24,
			nav: false,
			smartSpeed: 2000,
