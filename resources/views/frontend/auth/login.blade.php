                              ...
                              <div class="log-form pt-3">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="pass-group">
                                       <input type="password" name="password" class="form-control w-100" placeholder="*************" id="myInput">
								...
								<button id="engineer-login" class="btn btn-primary w-100 mx-auto text-center text-white d-block border-0 login-btn engineer-login"
                                 >Login
								</button>
                              <hr>
                        ...
                        <div class="tab-pane fade show active" id="ex1-tabs-2" role="tabpanel"
						   ...
						   @csrf
                              ...
                              <div class="log-form pt-3">
                                 <div class="form-group">
                                    <label class="col-form-label text-start d-block fs-14 fw-bold">Phone Number</label>
                                    <input type="number" class="form-control " id="username" name="mobile"
                                       placeholder="Enter Mobile Number" autocomplete="off" data-intl-tel-input-id="0">
                                 </div>
                                 <div class="form-group">
                                    <label class="col-form-label text-start d-block fs-14 fw-bold">Password</label>
                                    <div class="pass-group">
                              ...
                              <button id="customer-login" type="button" class="btn btn-primary w-100 mx-auto text-center text-white d-block border-0 customer-login login-btn"
                                >Login
                              </button>
                              <hr>
                              <p class="no-acc fs-16 mb-0">Don't have an account ? <a href="{{ url('register') }}"
...
$(document).on('click','.engineer-login',function(e) {
  ...
  var clk_btn = $("#engineer-login");
	...
	var formData = new FormData(document.getElementById("engineer-login"));
...
$(document).on('click','.customer-login',function(e) {
  ...
  var clk_btn = $("#customer-login");
      clk_btn.prop('disabled',true);

	// var formData = new FormData(this);
	var formData = new FormData(document.getElementById("customer-login"));
	console.log(formData);
    $.ajaxSetup({
		headers: {
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
