                     ...
                     <div class="col-md-12">
                        ...
                        <div class="log-form pt-3">
                           ...
                           <div class="form-group">
                              ...
                              <button id="customer-save" disabled class="btn btn-primary w-25 mx-auto mt-3 text-center text-white d-block border-0 login-btn customer-save"
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 <input type="number" class="form-control" id="" name=""
                                    placeholder="Enter OTP" autocomplete="off" data-intl-tel-input-id="0">
                                 <!-- <button onclick="getEmailOTP()" class="btn btn-primary rounded-pill position-absolute end-0 me-1" type="button" id="send-email-otp" style="width:100px; margin-top:0.5%;" >Send OTP</button> -->
                                 @if ($errors->has('email'))
                                 <span class="text-danger">{{ $errors->first('email') }}</span>
                                 @endif
