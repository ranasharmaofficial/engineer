						...
						<div class="row">
							...
							<div class="col-lg-6 d-flex flex-column">
								<div class="d-flex align-items-center justify-content-between">
									<h6 class="user-title">Ongoing Jobs</h6>
									<a href="ongoing-jobs.php"
										class="btn btn-primary2 border my-1 h-auto lh-base rounded-pill py-3 text-white me-3">
											...
											<tr>
												<td>
													<h2 class="table-avatar ps-0">
														<a href="#" class="avatar avatar-m me-2"><i class="fa fa-users"
															aria-hidden="true"></i>
														</a>
														<a href="#">New Installtion & Configuration... <span><i
															class="feather-calendar"></i> 22 Sep 2022</span>
														</a>
													</h2>
												</td>
												<td class="text-center p-0">
													<a href="javascript:void();" class="btn btn-primary2 rounded-pill"
											...
											<tr>
												<td>
													<h2 class="table-avatar ps-0">
														...
														<a href="#">New Installtion & Configuration... <span><i
																	class="feather-calendar"></i> 22 Sep 2022</span></a>
													</h2>
												</td>
												<td class="text-center p-0">
													<a href="javascript:void();" class="btn btn-primary2 rounded-pill"
														data-bs-toggle="modal" data-bs-target="#add-wallet">View
														More</a>
												</td>
											</tr>
											<tr>
							...
							<div class="col-lg-6 d-flex flex-column">
								<div class="d-flex align-items-center justify-content-between">
									<h6 class="user-title">Upcoming Jobs</h6>
									<a href="upcoming-jobs.php"
										class="btn btn-primary2 border my-1 h-auto lh-base rounded-pill py-3 text-white me-3">
										View All <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
									</a>
								</div>
