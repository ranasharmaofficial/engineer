                ...
                <div class="col-md-8 col-lg-9">
                    <div class="row">
                        <div class="widget-title d-flex align-items-center justify-content-between">
                            <h4 class="d-none d-lg-inline-block fw-bold">Upcoming Services</h4>
                    ...
                    <div class="row mt-4 border border-1 py-3 rounded">
                        ...
                        <div class="col-lg-9 mt-3 mt-lg-0">
                            <div class="d-flex">
                                ...
                                <span class="badge bg-success text-white fw-bold ms-2 px-3">Upcoming</span>
                            </div>
                    ...
                    <div class="row mt-4 border border-1 py-3 rounded">
                        ...
                        <div class="col-lg-9 mt-3 mt-lg-0">
                            ...
                            <ul class="booking-details">
                                ...
                                <li>
                                    <span class="book-item fw-bold">Order Date</span> : 27 Sept 2023
                                </li>
                                <li>
                                    <span class="book-item fw-bold">Assigned Engineer</span> : SPE0024
                                </li>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <form>
                        <div class="col-12">
                            <label class="d-none">Service Cancellation:</label>
                            <textarea rows="5" placeholder="Please Enter Reason for Cancellation"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <form action="">
                        <div class="col-12">
                            <label class="d-none">Service Cancellation:</label>
                            <textarea rows="5" placeholder="Please Enter Your Query" class="form-control"></textarea>
                        </div>
                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-info login-button">Submit</button>
                        </div>
