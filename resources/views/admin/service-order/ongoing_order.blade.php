            ...
            <div class="row align-items-center justify-conent-between">
                ...
                <div class="col">
                    ...
                    <div class="breadcrumb  "><a href="{{ url('admin/service-order') }}">
						<i class="fa fa-home" aria-hidden="true"></i> Order</a> / Ongoing Order
					</div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="row gutters-5 align-items-center">
                                    ...
                                    <div class="col pr-0">
                                        ...
                                        <h5 class="mb-md-0 h6">Ongoing Order List</h5>
                                    ...
                                    <div class="col text-right">
										...
										<a href="{{ route('admin.order.ongoingOrder') }}" class="btn btn-circle btn-warning h-35">
											<span>Refresh</span>
										</a>
