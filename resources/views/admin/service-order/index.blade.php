        ...
        <div class="page-header mb-0 mt-3">
            ...
            <div class="row align-items-center justify-conent-between">
                ...
                <div class=" col">
                    ...
                    <a href="{{ route('admin.service-order.create') }}" class="btn btn-info float-right veiwbutton"><i class="fa fa-plus" aria-hidden="true"></i> Add New Service</a>
                        ...
                        <div class="card-body">
                                ...
                                <div class="row gutters-5 align-items-center">
                                    ...
                                    <div class="col text-right">
										...
										<a href="{{ url('admin/service-order') }}" class="btn btn-circle btn-warning h-35">
											<span>Refresh</span>
										</a>
