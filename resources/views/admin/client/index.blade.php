                        ...
                        <div class="card1">
                            <form method="get" class="row gutters-5 align-items-center">
                                ...
                                <div class="col text-right">
                                    <a href="{{ route('admin.clientExport') }}" class="btn btn-circle btn-info h-35" download>
                                        <span>Export in Excel</span>
                                    </a>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group mb-0">
                                        <input type="text" value="{{ $request->search }}" class="form-control form-control-sm h-35" id="search"
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="w-50px" src="{{ static_asset('uploads/'.$value->logo) }}" title="content_image">
                                        </td>
                                        <td>
                                             @if($value->status == 1) <p class="text-success font-weight-bold">Active </p> @endif
                                             @if($value->status == 0) <p class="text-danger font-weight-bold">Inactive </p> @endif
                                            </select>
                                        </td>
                                        <td>
                                            <form class="d-flex">
                                                ...
                                                <a href="{{ route('admin.deleteClient', $value->id) }}" onclick="return confirm('Are you sure want to delete this')" type="button"
