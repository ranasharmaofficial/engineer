            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="breadcrumb "><a href="index.php"><i class="fa fa-home" aria-hidden="true"></i>
                            Dashboard</a> / Service Management</div>
                </div>
                <div class="col">
            ...
            <div class="profile-menu">
                <ul class="nav nav-tabs nav-tabs-solid">
                    <li class="nav-item"> <a class="nav-link active border rounded-top" data-toggle="tab"
                            href="#indian_cuisine">Add Engineer Working Hours</a> </li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="emp_fname" value="">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-12  col-form-label">Engineer Id</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="emp_lname" value="">
                                        <div class="error-msg" role="alert"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="emp_email" value="">
                                        <div class="error-msg" role="alert"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="emp_mobileno" value="">
                                        <div class="error-msg" role="alert"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-12  col-form-label">Working Type </label>
                                    <div class="col-sm-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-12  col-form-label">Working Hrs.</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="emp_mobileno" value="">
                                        <div class="error-msg" role="alert"></div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-12  col-form-label"> Skill</label>
                                    <div class="col-sm-12">
