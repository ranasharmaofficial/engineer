               ...
               <div class="profile-menu">
                  <ul class="nav nav-tabs nav-tabs-solid">
                     <li class="nav-item"> <a class="nav-link active border rounded-top" data-toggle="tab"
                        href="#indian_cuisine">Update Service Category</a> 
                     </li>
                  </ul>
               </div>
               <div class="tab-content profile-tab-cont mt-1">
                  <div class="tab-pane fade active show" id="indian_cuisine">
                     <h6
                        ...
                        Update Service Category</h6>
                     <form class="form-sample p-2" action="{{ route('admin.service_category.update',$page->id) }}" method="post">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group row mb-0 align-items-center">
                                       ...
                                       <div class="col-sm-12">
                                          <input type="text" class="form-control" value="{{ $page->name }}" name="name" id="description">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="form-group row mb-0">
                                       ...
                                       <div class="col-sm-12">
										  <select class="form-control" name="status">
											 ...
											 <option @if($page->status == 2) selected @endif value="2">Inactive</option>
										  </select>
                                       </div>
                                    </div>
                                 </div>
